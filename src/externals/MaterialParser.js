import { PBRMaterial, DRAW_SIDE, TEXEL_ENCODING_TYPE } from 't3d';
import { KHR_materials_unlit as _KHR_materials_unlit } from 't3d/addons/loaders/glTF/extensions/KHR_materials_unlit.js';
import { KHR_materials_pbrSpecularGlossiness as _KHR_materials_pbrSpecularGlossiness } from 't3d/addons/loaders/glTF/extensions/KHR_materials_pbrSpecularGlossiness.js';
import { KHR_materials_clearcoat as _KHR_materials_clearcoat } from 't3d/addons/loaders/glTF/extensions/KHR_materials_clearcoat.js';
import { KHR_texture_transform } from 't3d/addons/loaders/glTF/extensions/KHR_texture_transform.js';
import { ALPHA_MODES } from 't3d/addons/loaders/glTF/Constants.js';

import { ClusteredLightingPBRMaterial } from 't3d/examples/jsm/materials/ClusteredLightingPBRMaterial.js';
  ...
  static parse(context) {
    ...
    for (let i = 0; i < gltf.materials.length; i++) {
      ...
      if (KHR_materials_unlit) {
        ...
        material = new ClusteredLightingPBRMaterial(); // use clustered lighting
      }
